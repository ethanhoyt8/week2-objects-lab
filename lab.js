...
/*
  ...
  Give it a key of name with the value being your name, and another key of age with 
  the value being your age.
*/
...
/*
  After you've made your object, use bracket or dot notation to add another key 
  named 'car' with the value being your favorite car and then another key 
...
favoriteThings.show = 'The last of us'
console.log(favoriteThings)
...
/*
  ...
  be 'Harry Potter'. (If they were either of those things already, change them to something else.)
*/

//Code here
favoriteThings.food = "Chicken Nuggets"
favoriteThings["book"] = "Hunger Games"
console.log(favoriteThings)
...
console.log(`In ${year} a truck was made by ${make} called a ${model} and it was painted ${color}.`)
...
//////////////////////////// PROBLEM 12 ////////////////////////////
/*
  Create a class called 'Cat'. Make sure to call your constructor, and require these 
  3 parameters: name, age, color.
...
/*
  Create a new boat using your class. You can choose whatever values you like for all 
  the 
